  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              <span className="px-3 py-1 bg-surface-container-high rounded-full text-xs font-bold text-on-surface-variant cursor-pointer">All Assets</span>
              <span className="px-3 py-1 bg-surface-container-high rounded-full text-xs font-bold text-on-surface-variant cursor-pointer">Filter</span>
            </div>
          </div>
          ...
          {/* Entry 2 */}
          <div className="bg-surface-container rounded-2xl overflow-hidden shadow-xl border border-outline-variant/5 opacity-80 hover:opacity-100 transition-opacity">
            <div className="p-8 space-y-8">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-surface-container-highest flex items-center justify-center">
        ...
        <div className="lg:col-span-1 space-y-8">
          <div className="bg-surface-container-high rounded-3xl p-8 relative overflow-hidden group">
            ...
            <button className="w-full bg-primary text-on-primary font-bold py-4 rounded-xl active:scale-95 duration-200 shadow-lg shadow-primary/20">NEW ENTRY</button>
          </div>
          ...
          <div className="bg-surface-container-lowest rounded-2xl p-6 border border-outline-variant/10">
            ...
            <div className="flex justify-between items-center text-[10px] text-outline font-bold uppercase">
              ...
              <span className="text-primary cursor-pointer hover:underline">View Checklist</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="fixed bottom-24 right-8 z-40 lg:bottom-12">
        <button className="w-14 h-14 rounded-full bg-primary text-on-primary flex items-center justify-center shadow-2xl active:scale-90 duration-150">
          <Plus size={28} />
        </button>
      </div>
    </motion.div>
